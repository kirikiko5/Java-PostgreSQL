...
CREATE INDEX "IX_Relationship29" ON "Entradas" ("Fecha_Oferta")
;
...
ALTER TABLE "Opinion" ADD CONSTRAINT "Key5" PRIMARY KEY ("Nombre de Usuario","Fecha")
;
...
ALTER TABLE "Sorteo" ADD CONSTRAINT "Key9" PRIMARY KEY ("Nombre","Fecha")
;
...
ALTER TABLE "Entradas" ADD CONSTRAINT "Promociona" FOREIGN KEY ("Fecha_Oferta") REFERENCES "Oferta" ("Fecha") ON DELETE CASCADE ON UPDATE CASCADE
;
